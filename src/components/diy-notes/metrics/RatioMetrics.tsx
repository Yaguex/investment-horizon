  ...
  return (
    <div className="flex gap-8 items-start">
      <div className="text-center">
        <MetricTooltip description="Annualized ROI should we reach our target by expiration">
      ...
      <div className="text-center">
        <MetricTooltip description="How many dollars can I potentially earn for every dollar I give up at the risk-free rate. Anything above 4-to-1 is a pretty good convexity bet">
